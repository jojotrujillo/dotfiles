...
# git completions
. ~/.local/scripts/git-completion.bash

# git prompt enhancements
. ~/.local/scripts/git-prompt.sh
...
if [ "$color_prompt" = yes ]; then
    PS1="[${debian_chroot:+($debian_chroot)}\[\033[01;32m\]\u@\h\[\033[00m\]:\[\033[01;34m\]\w\[\033[01;31m\]$PS1\[\033[00m\]]\$ "
else
